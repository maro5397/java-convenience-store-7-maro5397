...
- **프로모션 할인 적용**
    - `processAdditionalPromotionDiscount(Order order)`: 주문에 프로모션 할인 추가 적용
- **프로모션 미적용 상품 제외**
    - `processNonePromotionProductDelete(Order order)`: 프로모션 수량 부족으로 프로모션 미적용 상품 제외
...
- **프로모션 정책을 적용했을때 결과**
    - `promotionApplyFreeItemQuantity`: 프로모션 적용 상품 중 무료로 받을 수 있는 상품 개수
    - `promotionApplyPaidItemQuantity`: 프로모션 적용 상품 중 유료로 받을 수 있는 상품 개수
    - `promotionProductConsumeQuantity`: 프로모션 재고 차감 수
    - `productConsumeQuantity`: 일반 재고 차감 수
    - `getNonDiscountedOrderQuantity()`: 프로모션 적용을 받지 않는 상품 개수
...
- **프로모션 정책 관리**
    ...
    - `canApplyPromotion(int quantity, int remainingPromotionStock)`: 프로모션 추가 적용이 가능한지 유무를 확인
...
- **프로모션 할인 적용**
    - `getTotalPromotionDiscount()`: 프로모션 할인 조건을 충족하는 상품에 대해 무료 증정 혜택을 적용하고 할인 금액을 계산
- **멤버십 할인 적용**
...
- **프로모션 적용**
    - `consumeStockForOrder()`: 모든 요구 조건을 만족한 OrderResult에 따라 재고 소모
    - `reduceQuantityForNonDiscountedOrder()`: 프로모션 적용 후 결과를 OrderResult 필드에 기록
